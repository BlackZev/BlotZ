...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'be757618-ed43-4a80-be70-620fd31670db' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('c3508000-fb17-470c-a4ba-000a793dd860');
      cy.get(`[data-cy="name"]`).should('have.value', 'c3508000-fb17-470c-a4ba-000a793dd860');
